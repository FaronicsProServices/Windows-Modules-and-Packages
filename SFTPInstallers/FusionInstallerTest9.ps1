...
try {
    ...
    # Correct property name with proper capitalization for WinSCP .NET assembly
...
try {
    ...
    if (-not $licFile) {
        ...
        throw "License file '$LicenseFileName' not found inside the extracted package. Available files were: $($allExtracted -join ', ')"
    }
