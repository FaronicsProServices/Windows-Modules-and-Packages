...
param(
    ...
    [Parameter(Mandatory = $false)]
    [string]$GitHubBaseUrl = "https://raw.githubusercontent.com/FaronicsProServices/YourRepoName/main",
...
# Download WinSCP dependencies directly from your GitHub repository
try {
