...
Write-Host "Arguments : /type Silent /DisableExternalServices" -ForegroundColor Cyan
Write-Host "Starting installer..." -ForegroundColor Cyan
Write-Host ""

# YOUR EXACT INSTALL COMMAND
$FusionProcess = Start-Process `
...
Write-Host "Installer Exit Code: $($FusionProcess.ExitCode)" -ForegroundColor Cyan
