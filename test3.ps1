...
$sevenZipUrl = "https://www.7-zip.org/a/7z2301-extra.zip"  # ✅ Zip instead of .7z
$downloadPath = "$env:TEMP\setup.zip"
$extractPath = "$env:TEMP\ReadWriteExtract"
$sevenZipArchive = "$env:TEMP\7z.zip"
...
# Download 7-Zip portable ZIP version
...
# Extract Read&Write ZIP using 7-Zip
